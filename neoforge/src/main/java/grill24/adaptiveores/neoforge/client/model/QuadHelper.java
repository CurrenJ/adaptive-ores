...
public class QuadHelper {
    ...
    public static BakedQuad createQuad(Direction direction, TextureAtlasSprite sprite, float offset) {
        ...
        if (AdaptiveOresNeoForge.RENDER_DEBUG) {
            ...
            AdaptiveOresNeoForge.LOGGER.debug("Creating quad for direction={}, sprite={}, UV range: u0={}, v0={}, u16={}, v16={}",
        ...
        if (AdaptiveOresNeoForge.RENDER_DEBUG) {
            AdaptiveOresNeoForge.LOGGER.debug("Baked quad for direction={}, tintIndex={}, sprite={}",
