...
public class AdaptiveOreModelLoader implements IGeometryLoader<AdaptiveOreModelLoader.AdaptiveOreGeometry> {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(AdaptiveOres.MOD_ID, "adaptive_ore");
    ...
    public AdaptiveOreGeometry read(@Nonnull JsonObject jsonObject,
        ...
        grill24.adaptiveores.foundation.OreType oreType = grill24.adaptiveores.foundation.OreType.valueOf(oreTypeName.toUpperCase());
    ...
    public static class AdaptiveOreGeometry implements IUnbakedGeometry<AdaptiveOreGeometry> {
        ...
        private final grill24.adaptiveores.foundation.OreType oreType;
        ...
        public BakedModel bake(@Nonnull IGeometryBakingContext context,
            ...
            try {
                ...
                grill24.adaptiveores.AdaptiveOres.LOGGER.error("Failed to bake overlay model for {}: {}", overlayTexture, e.getMessage());
            }

            // Create and return the baked model
            AdaptiveOresNeoForge.LOGGER.info("AdaptiveOreGeometry: Baked model for ore type {} with overlay {}", oreType.getName(), overlayTexture);
